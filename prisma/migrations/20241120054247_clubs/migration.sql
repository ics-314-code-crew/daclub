/*
  ...
  - Added the required column `expiration` to the `Club` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `meetingTime` to the `Club` table without a default value. This is not possible if the table is not empty.
